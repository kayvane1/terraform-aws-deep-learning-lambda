...
| Name | Description |
|------|-------------|
| <a name="output_container_name"></a> [container\_name](#output\_container\_name) | Name of the container created on which the lambda runs |
| <a name="output_function_names"></a> [function\_names](#output\_function\_names) | List of all generated lambda function names |
<!-- END_TF_DOCS -->